...
async function main() {
    ...
    try {
        ...
        const newBasket = initializeFruitBasket(userName);
        ...
        console.log(`${basketResponse.seller}'s ${basketResponse.fruitName} basket with id: ${basketResponse.id} successfully issued at price: ${basketResponse.price}`);
